...
public protocol APIRequest {
    ...
    func make(api: URLGenerator, method: HTTPMethod) throws -> URLRequest
}

public extension APIRequest where ResponseDataType == Data {
...
extension APIRequest {
    ...
    private func createBaseRequest(url: URL) -> URLRequest {
        return URLRequest(url: url, cachePolicy: .useProtocolCachePolicy, timeoutInterval: 30.0)
    }
